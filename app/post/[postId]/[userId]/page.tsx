        ...
        <div className="lg:w-[calc(100%-540px)] h-full relative">
          ...
          <div>
            <button
              ...
              className="absolute z-20 right-4 top-4 flex items-center justify-center rounded-full bg-gray-700 p-1.5 
              hover:bg-gray-800"
            >
            ...
            <button
              ...
              className="absolute z-20 right-4 top-20 flex items-center justify-center rounded-full bg-gray-700 p-1.5 
              hover:bg-gray-800"
            >
