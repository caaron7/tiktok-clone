...
export default function MenuItem({
  ...
  const icons = () => {
    if (iconString == "For You")
      return <AiOutlineHome size={sizesString} color={colorString} />;
    if (iconString == "Following")
      return <RiGroupLine size={sizesString} color={colorString} />;
    if (iconString == "LIVE")
      return <BsCameraVideo size={sizesString} color={colorString} />;
  };
  return (
    <>
